...
export const AddItemButton = (props: React.ComponentProps<"button">) => {
  ...
  return (
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger render={<Button type="button" variant="ghost" size="icon" onClick={() => add()} className={cn("button-add", `button-add-${source}`, className)} {...rest} />}><PlusCircle className="h-5 w-5" /></TooltipTrigger>
...
export const ClearArrayButton = (props: React.ComponentProps<"button">) => {
  ...
  return (
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger render={<Button type="button" variant="ghost" size="icon" {...props} />}><Trash className="h-5 w-5 text-red-500" /></TooltipTrigger>
        <TooltipContent>
...
export const RemoveItemButton = (props: React.ComponentProps<"button">) => {
  ...
  return (
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger render={<Button type="button" variant="ghost" size="icon" onClick={() => remove()} className={cn(
                            "button-remove",
                            `button-remove-${source}-${index}`,
                            className,
                          )} {...rest} />}><XCircle className="h-5 w-5 text-red-500" /></TooltipTrigger>
