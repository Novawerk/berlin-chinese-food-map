  ...
  return (
    <div className={cn("inline-block", className)} {...rest}>
      <DropdownMenu open={open} onOpenChange={setOpen}>
        <DropdownMenuTrigger render={<Button type="button" className="add-filter" variant={variant} size={size} aria-haspopup="true" />}><Filter className="h-4 w-4" />{translate("ra.action.add_filter")}</DropdownMenuTrigger>
